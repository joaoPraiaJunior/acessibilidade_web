(function () {
    ...
    function validaCampos(campo) {
        ...
        campo.parentElement.className = campo.parentElement.className.replace('contatoCampo--erro', 'contatoCampo--sucesso');
        campo.className = campo.className.replace('contatoCampo--validouErro', 'contatoCampo--validouFoi');
    }
