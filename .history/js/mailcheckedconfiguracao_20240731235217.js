(function () {
    ...
    if(sugestaoDeEmail.getAttribute('role') === 'alert') {
        sugestaoDeEmail.addEventListener('click', function() {
            campoEmail.value = sugestaoDeEmail.value.split('Você quis dizer: ')[1].split('?')[0];
        });
    }
