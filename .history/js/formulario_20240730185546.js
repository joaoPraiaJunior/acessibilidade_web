(function () {
    ...
    const listaDeEventos = ['invalid', 'blur'];
    ...
    function validaCampos(campo) {
        ...
        if (!validadorDeCampo) {
            ...
            campo.parentElement.classList.toggle('contatoCampo--erro');
            campo.classList.toggle('contatoCampo--validouErro');
        } else {
            campo.parentElement.classList.toogle('contatoCampo--sucesso');
            campo.classList.toogle('contatoCampo--validouFoi');
        }
    }
