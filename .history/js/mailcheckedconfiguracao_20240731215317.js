    ...
    campoEmail.addEventListener('blur', function () {
        Mailcheck.run({
            ...
            suggested: function (suggestion) {
                ...
                sugestaoDeEmail.style.display = 'block';
                ...
                sugestaoDeEmail.removeAttribute('disabled');
                sugestaoDeEmail.removeAttribute('aria-hidden');
                sugestaoDeEmail.sytle.minHeight = '10px';
            }
        });
    });
